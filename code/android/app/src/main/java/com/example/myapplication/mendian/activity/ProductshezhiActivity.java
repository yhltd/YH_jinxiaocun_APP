...
public class ProductshezhiActivity extends AppCompatActivity {
    ...
    public static class ProductshezhiAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            // 加载图片 - 支持URL和Base64
            loadImage(getSafeString(item.get("photo")), holder.photo);
            loadImage(getSafeString(item.get("photo1")), holder.photo1);
            loadImage(getSafeString(item.get("photo2")), holder.photo2);
