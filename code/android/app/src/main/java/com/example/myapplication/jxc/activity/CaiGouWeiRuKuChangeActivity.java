...
public class CaiGouWeiRuKuChangeActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.caigouweiruku_change);
        ...
        SpinnerAdapter adapter = new ArrayAdapter<String>(CaiGouWeiRuKuChangeActivity.this, android.R.layout.simple_spinner_dropdown_item, mxtype_array);
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        adapter = new ArrayAdapter<String>(CaiGouWeiRuKuChangeActivity.this, android.R.layout.simple_spinner_dropdown_item, shou_h_array);
                        Message msg = new Message();
                        msg.obj = adapter;
                        systemHandler.sendMessage(msg);
                    } catch (Exception e) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    adapter1 = new ArrayAdapter<String>(CaiGouWeiRuKuChangeActivity.this, android.R.layout.simple_spinner_dropdown_item, spDm_array);
                    ...
                    adapter2 = new ArrayAdapter<String>(CaiGouWeiRuKuChangeActivity.this, android.R.layout.simple_spinner_dropdown_item, shou_h_array);
                } catch (Exception e) {
                    e.printStackTrace();
                }
...
//    }
    ...
    public void updateClick(View v) {
        ...
        Handler saveHandler = new Handler(new Handler.Callback() {
            ...
            public boolean handleMessage(@NonNull Message msg) {
                if ((boolean) msg.obj) {
                    ToastUtil.show(CaiGouWeiRuKuChangeActivity.this, "保存成功");
                    back();
                } else {
                    ToastUtil.show(CaiGouWeiRuKuChangeActivity.this, "保存失败，请稍后再试");
                }
    ...
    private boolean checkForm() {
        if (orderid.getText().toString().equals("")) {
            ToastUtil.show(CaiGouWeiRuKuChangeActivity.this, "请输入订单号");
            return false;
        } else {
        ...
        if (spDm.getSelectedItem().toString().equals("")) {
            ToastUtil.show(CaiGouWeiRuKuChangeActivity.this, "请选择商品代码");
            return false;
        } else {
        ...
        if (cpname.getText().toString().equals("")) {
            ToastUtil.show(CaiGouWeiRuKuChangeActivity.this, "请输入商品名称");
            return false;
        } else {
        ...
        if (cplb.getText().toString().equals("")) {
            ToastUtil.show(CaiGouWeiRuKuChangeActivity.this, "请输入产品类别");
            return false;
        } else {
        ...
        if (cpsj.getText().toString().equals("")) {
            ToastUtil.show(CaiGouWeiRuKuChangeActivity.this, "请输入价格");
            return false;
        } else {
        ...
        if (cpsl.getText().toString().equals("")) {
            ToastUtil.show(CaiGouWeiRuKuChangeActivity.this, "请输入数量");
            return false;
        } else {
        ...
        if (cangku.getText().toString().equals("")) {
            ToastUtil.show(CaiGouWeiRuKuChangeActivity.this, "请输入仓库");
            return false;
        } else {
        ...
        if (mxtype.getSelectedItem().toString().equals("")) {
            ToastUtil.show(CaiGouWeiRuKuChangeActivity.this, "请选择明细类型");
            return false;
        } else {
        ...
        if (shou_h.getSelectedItem().toString().equals("")) {
            ToastUtil.show(CaiGouWeiRuKuChangeActivity.this, "请选择收/进货方");
            return false;
        } else {
        ...
        if ("是".equals(isRuku)) {
            // 如果选择"是"，向mingxi表插入数据
            Log.d("UpdateDebug", "选择入库，开始向mingxi表插入数据");
            // 更新入库状态到当前对象（如果需要）
            yhJinXiaoCunMingXi.setRuku("已入库");
        } else {
            yhJinXiaoCunMingXi.setRuku("");
        }
