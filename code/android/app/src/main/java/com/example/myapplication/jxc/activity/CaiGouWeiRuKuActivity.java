...
public class CaiGouWeiRuKuActivity extends AppCompatActivity {
...
//    private Button down_button;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.caigouweiruku);
...
//        down_button.setOnClickListener(downClick());
    ...
    protected void showDatePickDlg(final EditText editText) {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(CaiGouWeiRuKuActivity.this, new DatePickerDialog.OnDateSetListener() {
                ...
                try {
                    ...
                    if (ks.getText().toString().equals("") && js.getText().toString().equals("")) {
                        if(yhJinXiaoCunUser.getGongsi()!=null) {
                            list = yhJinXiaoCunMingXiService.getListcgwrk(yhJinXiaoCunUser.getGongsi());
                        }
                    } else {
                        if(yhJinXiaoCunUser.getGongsi()!=null) {
                            list = yhJinXiaoCunMingXiService.getQuerycgwrk(yhJinXiaoCunUser.getGongsi(), ks.getText().toString(), js.getText().toString());
                        }
                    }
                    if (list == null) return;
...
//                    for (int i = a1;  i < a1+5; i++) {
                ...
                adapter_block = new SimpleAdapter(CaiGouWeiRuKuActivity.this, data, R.layout.caigouweiruku_row_block, new String[]{"orderid", "spDm", "cpname", "cplb", "cpsj", "cpsl", "mxtype", "shijian", "gs_name", "shou_h","cangku"}, new int[]{R.id.orderid, R.id.spDm, R.id.cpname, R.id.cplb, R.id.cpsj, R.id.cpsl, R.id.mxtype, R.id.shijian, R.id.gs_name, R.id.shou_h,R.id.cangku}) {
                    @Override
                    public View getView(int position, View convertView, ViewGroup parent) {
                        final LinearLayout view = (LinearLayout) super.getView(position, convertView, parent);
                        LinearLayout linearLayout = (LinearLayout) view.getChildAt(0);
    ...
    public View.OnClickListener updateClick() {
        return new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(CaiGouWeiRuKuActivity.this, CaiGouWeiRuKuChangeActivity.class);
    ...
    public View.OnLongClickListener onItemLongClick() {
        return new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(CaiGouWeiRuKuActivity.this);
                int position = Integer.parseInt(view.getTag().toString());
                Handler deleteHandler = new Handler(new Handler.Callback() {
                    @Override
                    public boolean handleMessage(@NonNull Message msg) {
                        if ((boolean) msg.obj) {
                            ToastUtil.show(CaiGouWeiRuKuActivity.this, "删除成功");
                            initList();
                        }
                        return true;
                    }
                ...
                builder.setNeutralButton("查看详情", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent intent = new Intent(CaiGouWeiRuKuActivity.this, XiangQingYeActivity.class);
                        MyApplication myApplication = (MyApplication) getApplication();
