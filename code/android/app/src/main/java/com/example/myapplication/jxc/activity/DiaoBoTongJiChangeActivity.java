...
public class DiaoBoTongJiChangeActivity extends AppCompatActivity {
...
//    private Spinner shou_h;
    ...
    String[] spDm_array;
    String[] mxtype_array = new String[]{"调拨入库", "调拨出库"};
    String[] shou_h_array;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.diaobotongji_change);
        ...
        SpinnerAdapter adapter = new ArrayAdapter<String>(DiaoBoTongJiChangeActivity.this, android.R.layout.simple_spinner_dropdown_item, mxtype_array);
...
//                            }
//                        }
//                        adapter = new ArrayAdapter<String>(DiaoBoTongJiChangeActivity.this, android.R.layout.simple_spinner_dropdown_item, shou_h_array);
//                        Message msg = new Message();
//                        msg.obj = adapter;
//                        systemHandler.sendMessage(msg);
//                    } catch (Exception e) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    adapter1 = new ArrayAdapter<String>(DiaoBoTongJiChangeActivity.this, android.R.layout.simple_spinner_dropdown_item, spDm_array);
                    ...
                    adapter2 = new ArrayAdapter<String>(DiaoBoTongJiChangeActivity.this, android.R.layout.simple_spinner_dropdown_item, shou_h_array);
                } catch (Exception e) {
                    e.printStackTrace();
                }
...
//    }
    ...
    public void updateClick(View v) {
        ...
        Handler saveHandler = new Handler(new Handler.Callback() {
            ...
            public boolean handleMessage(@NonNull Message msg) {
                if ((boolean) msg.obj) {
                    ToastUtil.show(DiaoBoTongJiChangeActivity.this, "保存成功");
                    back();
                } else {
                    ToastUtil.show(DiaoBoTongJiChangeActivity.this, "保存失败，请稍后再试");
                }
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                Message msg = new Message();
                msg.obj = yhJinXiaoCunMingXiService.updatedbtj(yhJinXiaoCunMingXi);
    ...
    private boolean checkForm() {
        if (orderid.getText().toString().equals("")) {
            ToastUtil.show(DiaoBoTongJiChangeActivity.this, "请输入订单号");
            return false;
        } else {
        ...
        if (spDm.getSelectedItem().toString().equals("")) {
            ToastUtil.show(DiaoBoTongJiChangeActivity.this, "请选择商品代码");
            return false;
        } else {
        ...
        if (cpname.getText().toString().equals("")) {
            ToastUtil.show(DiaoBoTongJiChangeActivity.this, "请输入商品名称");
            return false;
        } else {
        ...
        if (cplb.getText().toString().equals("")) {
            ToastUtil.show(DiaoBoTongJiChangeActivity.this, "请输入产品类别");
            return false;
        } else {
        ...
        if (cpsj.getText().toString().equals("")) {
            ToastUtil.show(DiaoBoTongJiChangeActivity.this, "请输入价格");
            return false;
        } else {
        ...
        if (cpsl.getText().toString().equals("")) {
            ToastUtil.show(DiaoBoTongJiChangeActivity.this, "请输入数量");
            return false;
        } else {
        ...
        if (cangku.getText().toString().equals("")) {
            ToastUtil.show(DiaoBoTongJiChangeActivity.this, "请输入仓库");
            return false;
        } else {
        ...
        if (mxtype.getSelectedItem().toString().equals("")) {
            ToastUtil.show(DiaoBoTongJiChangeActivity.this, "请选择明细类型");
            return false;
        } else {
