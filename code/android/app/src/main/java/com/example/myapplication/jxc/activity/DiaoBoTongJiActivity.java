...
public class DiaoBoTongJiActivity extends AppCompatActivity {
...
public void onCreate(Bundle savedInstanceState) {
    ...
    protected void showDatePickDlg(final EditText editText) {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(DiaoBoTongJiActivity.this, new DatePickerDialog.OnDateSetListener() {
                ...
                try {
                    ...
                    if (ks.getText().toString().equals("") && js.getText().toString().equals("")) {
                        if(yhJinXiaoCunUser.getGongsi()!=null) {
                            list = yhJinXiaoCunMingXiService.getListdbtj(yhJinXiaoCunUser.getGongsi());
                        }
                    } else {
                        if(yhJinXiaoCunUser.getGongsi()!=null) {
                            list = yhJinXiaoCunMingXiService.dbtjquery(yhJinXiaoCunUser.getGongsi(), ks.getText().toString(), js.getText().toString());
                        }
                    }
                    if (list == null) return;
...
//                    for (int i = a1;  i < a1+5; i++) {
                ...
                adapter = new SimpleAdapter(DiaoBoTongJiActivity.this, data, R.layout.diaobotongji_row, new String[]{"orderid", "spDm", "cpname", "cplb", "cpsj", "cpsl", "mxtype", "shijian", "gs_name", "cangku"}, new int[]{R.id.orderid, R.id.spDm, R.id.cpname, R.id.cplb, R.id.cpsj, R.id.cpsl, R.id.mxtype, R.id.shijian, R.id.gs_name, R.id.cangku}) {
                    @Override
                ...
                adapter_block = new SimpleAdapter(DiaoBoTongJiActivity.this, data, R.layout.diaobotongji_row_block, new String[]{"orderid", "spDm", "cpname", "cplb", "cpsj", "cpsl", "mxtype", "shijian", "gs_name", "cangku"}, new int[]{R.id.orderid, R.id.spDm, R.id.cpname, R.id.cplb, R.id.cpsj, R.id.cpsl, R.id.mxtype, R.id.shijian, R.id.gs_name, R.id.cangku}) {
                    @Override
                    public View getView(int position, View convertView, ViewGroup parent) {
                        final LinearLayout view = (LinearLayout) super.getView(position, convertView, parent);
                        LinearLayout linearLayout = (LinearLayout) view.getChildAt(0);
...
//    }
    ...
    public View.OnClickListener exportClick() {
        return new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String[] title = {"订单号", "商品代码", "商品名称", "商品类别", "价格", "数量", "明细类型", "时间", "公司名","仓库"};
                String fileName = "调拨明细" + System.currentTimeMillis() + ".xls";
                ExcelUtil.initExcel(fileName, "调拨明细", title);
                ExcelUtil.dbtjToExcel(list, fileName, MyApplication.getContext());
                ...
                try {
                    ...
                    e.printStackTrace();
                    ToastUtil.show(DiaoBoTongJiActivity.this, "打开文件失败，请检查是否安装了WPS或Excel软件");
                }
            }
        };
    }
    ...
    public View.OnClickListener updateClick() {
        return new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(DiaoBoTongJiActivity.this, DiaoBoTongJiChangeActivity.class);
    ...
    public View.OnLongClickListener onItemLongClick() {
        return new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(DiaoBoTongJiActivity.this);
                int position = Integer.parseInt(view.getTag().toString());
                Handler deleteHandler = new Handler(new Handler.Callback() {
                    @Override
                    public boolean handleMessage(@NonNull Message msg) {
                        if ((boolean) msg.obj) {
                            ToastUtil.show(DiaoBoTongJiActivity.this, "删除成功");
                            initList();
                        }
                        return true;
                    }
                ...
                builder.setNeutralButton("查看详情", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        xiangQingYe.setJ(list.get(position).getcangku());

                        Intent intent = new Intent(DiaoBoTongJiActivity.this, XiangQingYeActivity.class);
                        MyApplication myApplication = (MyApplication) getApplication();
