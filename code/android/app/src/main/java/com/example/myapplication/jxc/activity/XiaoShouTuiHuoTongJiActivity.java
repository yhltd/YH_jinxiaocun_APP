...
public class XiaoShouTuiHuoTongJiActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.xsthtongji);  // 确保使用正确的布局文件
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    List<YhJinXiaoCunMingXi> salesReturnList = yhJinXiaoCunMingXiService.getQueryxsthtongji(
    ...
    protected void showDatePickDlg(final EditText editText) {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(XiaoShouTuiHuoTongJiActivity.this,
