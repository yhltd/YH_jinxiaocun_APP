...
public class CaiGouTuiHuoActivity extends AppCompatActivity {
...
//    private Button down_button;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.caigoutuihuo);
...
//        down_button.setOnClickListener(downClick());
    ...
    protected void showDatePickDlg(final EditText editText) {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(CaiGouTuiHuoActivity.this, new DatePickerDialog.OnDateSetListener() {
                ...
                try {
                    ...
                    if (ks.getText().toString().equals("") && js.getText().toString().equals("")) {
                        if(yhJinXiaoCunUser.getGongsi()!=null) {
                            list = yhJinXiaoCunMingXiService.getListcgth(yhJinXiaoCunUser.getGongsi());
                        }
                    } else {
                        if(yhJinXiaoCunUser.getGongsi()!=null) {
                            list = yhJinXiaoCunMingXiService.getQuerycgth(yhJinXiaoCunUser.getGongsi(), ks.getText().toString(), js.getText().toString());
                        }
                    }
                    if (list == null) return;
...
//                    for (int i = a1;  i < a1+5; i++) {
                ...
                adapter = new SimpleAdapter(CaiGouTuiHuoActivity.this, data, R.layout.caigoutuihuo_row, new String[]{"orderid", "spDm", "cpname", "cplb", "cpsj", "cpsl", "mxtype", "shijian", "gs_name", "shou_h","cangku"}, new int[]{R.id.orderid, R.id.spDm, R.id.cpname, R.id.cplb, R.id.cpsj, R.id.cpsl, R.id.mxtype, R.id.shijian, R.id.gs_name, R.id.shou_h,R.id.cangku}) {
                    @Override
                ...
                adapter_block = new SimpleAdapter(CaiGouTuiHuoActivity.this, data, R.layout.caigoutuihuo_row_block, new String[]{"orderid", "spDm", "cpname", "cplb", "cpsj", "cpsl", "mxtype", "shijian", "gs_name", "shou_h","cangku"}, new int[]{R.id.orderid, R.id.spDm, R.id.cpname, R.id.cplb, R.id.cpsj, R.id.cpsl, R.id.mxtype, R.id.shijian, R.id.gs_name, R.id.shou_h,R.id.cangku}) {
                    @Override
                    public View getView(int position, View convertView, ViewGroup parent) {
                        final LinearLayout view = (LinearLayout) super.getView(position, convertView, parent);
                        LinearLayout linearLayout = (LinearLayout) view.getChildAt(0);
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Uri fileUri = FileProvider.getUriForFile(
                            CaiGouTuiHuoActivity.this, // 使用当前Activity作为Context
                    ...
                    e.printStackTrace();
                    ToastUtil.show(CaiGouTuiHuoActivity.this, "打开文件失败，请检查是否安装了WPS或Excel软件");
                }
            }
        };
    }
    ...
    public View.OnClickListener updateClick() {
        return new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(CaiGouTuiHuoActivity.this, CaiGouTuiHuoChangeActivity.class);
    ...
    public View.OnLongClickListener onItemLongClick() {
        return new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(CaiGouTuiHuoActivity.this);
                int position = Integer.parseInt(view.getTag().toString());
                Handler deleteHandler = new Handler(new Handler.Callback() {
                    @Override
                    public boolean handleMessage(@NonNull Message msg) {
                        if ((boolean) msg.obj) {
                            ToastUtil.show(CaiGouTuiHuoActivity.this, "删除成功");
                            initList();
                        }
                        return true;
                    }
                ...
                builder.setNeutralButton("查看详情", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent intent = new Intent(CaiGouTuiHuoActivity.this, XiangQingYeActivity.class);
                        MyApplication myApplication = (MyApplication) getApplication();
                ...
                builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        new Thread(new Runnable() {
                            ...
                            public void run() {
                                Message msg = new Message();
                                msg.obj = yhJinXiaoCunMingXiService.deletecgwrk(list.get(position).getid());
