...
public class JinChuMingXiTongJiActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.jcmxtongji);  // 确保使用正确的布局文件
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    List<YhJinXiaoCunMingXi> salesReturnList = yhJinXiaoCunMingXiService.getQueryjcmingxitongji(
    ...
    private void setupLineChart(Map<String, Float> dailyData) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                // 创建数据集
                LineDataSet dataSet = new LineDataSet(entries, "出入库数量");
                ...
                // ==================== 关键修改1：X轴标签斜着显示 ====================
                // 设置X轴标签旋转45度，防止重叠
                xAxis.setLabelRotationAngle(-45);  // 负数表示逆时针旋转

                // 或者如果您想要更小的角度，可以使用 -30 或 -60
                // xAxis.setLabelRotationAngle(-30);  // 30度旋转
                ...
                Log.d("ChartStatus", "X轴标签旋转角度: " + xAxis.getLabelRotationAngle() + "度");
    ...
    protected void showDatePickDlg(final EditText editText) {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(JinChuMingXiTongJiActivity.this,
