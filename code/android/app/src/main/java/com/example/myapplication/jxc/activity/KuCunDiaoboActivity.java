...
public class KuCunDiaoboActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kucundiaobo);
    ...
    public void onInsertClick(View v) {
        ...
        for (int i = 0; i < list.size(); i++) {
            if (list.get(i).isCheck()) {
                ...
                if(list.get(i).getNum() == null || list.get(i).getJine() == null|| list.get(i).getcangku() == null){
                    ToastUtil.show(KuCunDiaoboActivity.this, "请将第 " + (i*1+1) + " 行的商品数量和单价以及仓库补全！");
                    return;
                    ...
                    ToastUtil.show(KuCunDiaoboActivity.this, "第 " + (i*1+1) + " 行的商品数量需要大于0！");
                    return;
                }
        ...
        if (jczlList.size() == 0) {
            ToastUtil.show(KuCunDiaoboActivity.this, "请先选择数据！");
            return;
        ...
        Intent intent = new Intent(KuCunDiaoboActivity.this, KuCunDiaoboChangeActivity.class);
