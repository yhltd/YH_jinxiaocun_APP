...
public class YingShouBaoBiaoActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.yingshoubaobiao);
...
//        initList();
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    adapter = new ArrayAdapter<String>(YingShouBaoBiaoActivity.this, android.R.layout.simple_spinner_dropdown_item, kehu_array);
                } catch (Exception e) {
                    e.printStackTrace();
                }
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    list1 = yhFinanceYingShouBaoBiaoService.getList_yingshou(yhFinanceUser.getCompany(),class_selectText,start_dateText,stop_dateText);
                    list2 = yhFinanceYingShouBaoBiaoService.getList_xiaoxiang(yhFinanceUser.getCompany(),class_selectText,start_dateText,stop_dateText);
                ...
                adapter = new SimpleAdapter(YingShouBaoBiaoActivity.this, data, R.layout.yingshoubaobiao_row, new String[]{"kehu","project","zhaiyao","jine1","unit","invoice_type","invoice_no","jine2"}, new int[]{R.id.kehu,R.id.project,R.id.zhaiyao,R.id.jine1,R.id.unit,R.id.invoice_type,R.id.invoice_no,R.id.jine2}) {
                    @Override
                ...
                adapter_block = new SimpleAdapter(YingShouBaoBiaoActivity.this, data, R.layout.yingshoubaobiao_row_block, new String[]{"kehu","project","zhaiyao","jine1","unit","invoice_type","invoice_no","jine2"}, new int[]{R.id.kehu,R.id.project,R.id.zhaiyao,R.id.jine1,R.id.unit,R.id.invoice_type,R.id.invoice_no,R.id.jine2}) {
                    @Override
                    public View getView(int position, View convertView, ViewGroup parent) {
                        final LinearLayout view = (LinearLayout) super.getView(position, convertView, parent);
                        LinearLayout linearLayout = (LinearLayout) view.getChildAt(0);
    ...
    protected void showDatePickDlg(final EditText editText) {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(YingShouBaoBiaoActivity.this, new DatePickerDialog.OnDateSetListener() {
