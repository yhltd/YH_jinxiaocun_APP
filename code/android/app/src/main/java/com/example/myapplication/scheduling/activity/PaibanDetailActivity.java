    ...
    private void initList() {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                SimpleAdapter adapter = new SimpleAdapter(PaibanDetailActivity.this, data, R.layout.paiban_detail_row, new String[]{"staffName", "phoneNumber", "idNumber", "departmentName", "banci","riqi"}, new int[]{R.id.staffName, R.id.phoneNumber, R.id.idNumber, R.id.departmentName, R.id.banci, R.id.riqi}) {
                    @Override
