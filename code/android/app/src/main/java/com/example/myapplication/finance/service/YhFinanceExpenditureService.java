...
//经营收入
public class YhFinanceExpenditureService {
    ...
    public List<YhFinanceExpenditure> getList(String company) {
        String sql = "select id,financingExpenditure as shouru,company from financingExpenditure where company = ?";
    ...
    public boolean insert(YhFinanceExpenditure YhFinanceExpenditure) {
        String sql = "insert into FinancingExpenditure(financingExpenditure,company) values(?,?)";
        base = new financeBaseDao();
    ...
    public boolean update(YhFinanceExpenditure YhFinanceExpenditure) {
        String sql = "update FinancingExpenditure set financingExpenditure=? where id=? ";
        base = new financeBaseDao();
    ...
    public boolean delete(int id) {
        String sql = "delete from FinancingExpenditure where id = ?";
        base = new financeBaseDao();
