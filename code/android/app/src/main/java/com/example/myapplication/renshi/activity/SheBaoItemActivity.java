    ...
    private void initList() {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                adapter = new SimpleAdapter(SheBaoItemActivity.this, data, R.layout.shebaoitem_row, new String[]{"B","C","D","E","F","G","H","I","J","K","L","M","N"}, new int[]{R.id.B,R.id.C, R.id.D, R.id.E, R.id.F, R.id.G, R.id.H, R.id.I, R.id.J, R.id.K, R.id.L, R.id.M, R.id.N}) {
                    @Override
                ...
                adapter_block = new SimpleAdapter(SheBaoItemActivity.this, data, R.layout.shebaoitem_row_block, new String[]{"B","C","D","E","F","G","H","I","J","K","L","M","N"}, new int[]{R.id.B,R.id.C, R.id.D, R.id.E, R.id.F, R.id.G, R.id.H, R.id.I, R.id.J, R.id.K, R.id.L, R.id.M, R.id.N}) {
                    @Override
                    public View getView(int position, View convertView, ViewGroup parent) {
                        final LinearLayout view = (LinearLayout) super.getView(position, convertView, parent);
                        LinearLayout linearLayout = (LinearLayout) view.getChildAt(0);
